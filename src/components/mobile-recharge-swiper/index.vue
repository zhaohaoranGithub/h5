<template>
  <div class="mobile-warpper">
    ...
    <div class="swiper-pagination mobile-swiper-pagination" :class="swiperPaginationClassName"></div>
  </div>
</template>

<script>
export default {
  name: "mobile-recharge-swiper",
  data() {
    const vm = this;
    return {
      swiperOption: {
        pagination: {
          el: "." + vm.swiperPaginationClassName,
          type: "bullets",
...
.mobile-warpper {
  ...
  height: 503px;
  margin: 0 auto;
  background: url("./mobile-recharge-bg.png") no-repeat center center;
